 ...
 * Local function
 */
static int pins_dot_grapher_component_query(mca_base_module_t **module, int *priority);

/*
 * Instantiate the public struct with all of our public information
 * and pointers to our public functions in it
 */
const parsec_pins_base_component_t parsec_pins_dot_grapher_component = {
...

    {
        ...
        NULL,
        NULL,
        pins_dot_grapher_component_query,
...
{
    return (mca_base_component_t *)&parsec_pins_dot_grapher_component;
}

static int pins_dot_grapher_component_query(mca_base_module_t **module, int *priority)
{
    /* module type should be: const mca_base_module_t ** */
    void *ptr = (void*)&parsec_pins_dot_grapher_module;
    *priority = 50;
